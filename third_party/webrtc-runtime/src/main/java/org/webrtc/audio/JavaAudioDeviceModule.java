...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private AudioRecordFactory audioRecordFactory;
    ...
    /**
     * Overrides creation of WebRTC's AudioRecord input. The default remains microphone capture.
     */
    public Builder setAudioRecordFactory(AudioRecordFactory audioRecordFactory) {
    ...
    public JavaAudioDeviceModule createAudioDeviceModule() {
      ...
      final WebRtcAudioRecord audioInput = new WebRtcAudioRecord(context, executor, audioManager,
          ...
          samplesReadyCallback, audioRecordDataCallback, audioRecordFactory,
