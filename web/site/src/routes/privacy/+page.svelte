...
<Seo
  title="Privacy"
  description="PlayBridge has no accounts, no telemetry, and runs only on your local network. Nothing leaves your home."
  path="/privacy"
/>
...
<style>
  ...
  .prose p { margin-top: 18px; font-size: 15px; line-height: 1.7; }
