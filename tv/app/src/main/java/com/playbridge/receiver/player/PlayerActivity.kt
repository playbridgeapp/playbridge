...
class PlayerActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FileLogger.i(TAG, "=== PlayerActivity CREATED ===")
    ...
    private fun createPlayerListener() = object : androidx.media3.common.Player.Listener {
        ...
        override fun onPlayerError(error: androidx.media3.common.PlaybackException) {
            ...
            if (isDecoderInitFailure) {
                ...
                runOnUiThread {
                    android.widget.Toast.makeText(this@PlayerActivity, "Audio track not supported, reverting", android.widget.Toast.LENGTH_SHORT).show()
                }
                player?.let { p ->
    ...
    private fun playPreviousInPlaylist() {
        ...
        lifecycleScope.launch {
            ...
            android.widget.Toast.makeText(this@PlayerActivity, title, android.widget.Toast.LENGTH_SHORT).show()
    ...
    private fun playNextInPlaylist() {
        lifecycleScope.launch {
            ...
            android.widget.Toast.makeText(this@PlayerActivity, "Next: $title", android.widget.Toast.LENGTH_SHORT).show()
